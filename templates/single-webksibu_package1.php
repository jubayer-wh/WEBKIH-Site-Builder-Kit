...
$destinations = (string) get_post_meta($id, '_webksibu_pkg1_destinations', true);
$book_text = (string) get_post_meta($id, '_webksibu_pkg1_book_text', true);
$book_url  = (string) get_post_meta($id, '_webksibu_pkg1_book_url', true);
...
<div class="webksibu-package1-single">
    ...
    <div class="webksibu-package1-hero" style="<?php echo $img ? 'background-image:url(' . esc_url($img) . ');' : ''; ?>">
    ...
    <div class="webksibu-package1-container">
        ...
        <div class="webksibu-package1-sidebar">
            <div class="webksibu-package1-widget">
                ...
                <?php if ( $price !== '' ) : ?>
                    <p><strong>Price:</strong> <span class="webksibu-p-amt"><?php echo esc_html($price); ?></span></p>
                <?php endif; ?>
                ...
                ?>
                <a href="<?php echo esc_url($final_book_url); ?>" class="webksibu-p-btn">
